...
RESOURCES += src/qt/zix.qrc src/qt/zix_locale.qrc

TRANSLATIONS += src/qt/locale/zix_bg.ts \
                src/qt/locale/zix_de.ts \
                src/qt/locale/zix_en.ts \
                src/qt/locale/zix_es.ts \
                src/qt/locale/zix_fi.ts \
                src/qt/locale/zix_fr.ts \
                src/qt/locale/zix_it.ts \
                src/qt/locale/zix_ja.ts \
                src/qt/locale/zix_pl.ts \
                src/qt/locale/zix_pt.ts \
                src/qt/locale/zix_ru.ts \
                src/qt/locale/zix_sk.ts \
                src/qt/locale/zix_sv.ts \
                src/qt/locale/zix_vi.ts \
                src/qt/locale/zix_zh_CN.ts \
                src/qt/locale/zix_zh_TW.ts
