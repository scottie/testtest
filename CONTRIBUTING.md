Contributing to Zix Core
============================

The Zix Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Zix Core project, and is not to be
confused with overall Zix Network Protocol consensus changes.

Whether a pull request is merged into Zix Core rests with the project merge
...
Patches that change Zix consensus rules are considerably more involved than
...
Where a patch set proposes to change the Zix consensus, it must have been
...
The project leader is the release manager for each Zix Core release.
