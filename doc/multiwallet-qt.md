...
In order to support loading of multiple wallets in zix-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is zix.cpp.
...
Changes to zix.cpp
----------------------
zix.cpp is the entry point into zix-qt, and as such, will require some minor modifications to provide hooks for
