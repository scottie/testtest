...
Clone the git repositories for zix and gitian and then checkout the zix version that you want to build.
...
Follow the instructions in [doc/release-process.md](release-process.md) in the zix repository
...
gitian builds' in [doc/release-process.md](release-process.md) in the zix repository.
...
```bash
    Initialized empty Git repository in /home/debian/gitian-builder/inputs/zix/.git/
    remote: Reusing existing pack: 35606, done.
    remote: Total 35606 (delta 0), reused 0 (delta 0)
    Receiving objects: 100% (35606/35606), 26.52 MiB | 4.28 MiB/s, done.
    Resolving deltas: 100% (25724/25724), done.
    From https://github.com/eastcoastcrypto/Zix
...
For example:
```bash
URL=https://github.com/eastcoastcrypto/Zix.git
COMMIT=b616fb8ef0d49a919b72b0388b091aaec5849b96
./bin/gbuild --commit zix=${COMMIT} --url zix=${URL} ../Zix/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit zix=${COMMIT} --url zix=${URL} ../Zix/contrib/gitian-descriptors/gitian-win.yml
./bin/gbuild --commit zix=${COMMIT} --url zix=${URL} ../Zix/contrib/gitian-descriptors/gitian-osx.yml
```
...
```bash
    gpg --detach-sign ${VERSION}-linux/${SIGNER}/zix-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/zix-build.assert
    gpg --detach-sign ${VERSION}-osx/${SIGNER}/zix-build.assert
```
