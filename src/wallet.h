...
// Possible states for zZIX send
enum ZerocoinSpendStatus {
    ZZIX_SPEND_OKAY = 0,                            // No error
    ZZIX_SPEND_ERROR = 1,                           // Unspecified class of errors, more details are (hopefully) in the returning text
    ZZIX_WALLET_LOCKED = 2,                         // Wallet was locked
    ZZIX_COMMIT_FAILED = 3,                         // Commit failed, reset status
    ZZIX_ERASE_SPENDS_FAILED = 4,                   // Erasing spends during reset failed
    ZZIX_ERASE_NEW_MINTS_FAILED = 5,                // Erasing new mints during reset failed
    ZZIX_TRX_FUNDS_PROBLEMS = 6,                    // Everything related to available funds
    ZZIX_TRX_CREATE = 7,                            // Everything related to create the transaction
    ZZIX_TRX_CHANGE = 8,                            // Everything related to transaction change
    ZZIX_TXMINT_GENERAL = 9,                        // General errors in MintToTxIn
    ZZIX_INVALID_COIN = 10,                         // Selected mint coin is not valid
    ZZIX_FAILED_ACCUMULATOR_INITIALIZATION = 11,    // Failed to initialize witness
    ZZIX_INVALID_WITNESS = 12,                      // Spend coin transaction did not verify
    ZZIX_BAD_SERIALIZATION = 13,                    // Transaction verification failed
    ZZIX_SPENT_USED_ZZIX = 14                       // Coin has already been spend
};
...
public:
    ...
    */
    ...
    void setZZixAutoBackups(bool fEnabled)
    {
