...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Zix features */
        {"zix", "masternode", &masternode, true, true, false},
        {"zix", "listmasternodes", &listmasternodes, true, true, false},
        {"zix", "getmasternodecount", &getmasternodecount, true, true, false},
        {"zix", "masternodeconnect", &masternodeconnect, true, true, false},
        {"zix", "masternodecurrent", &masternodecurrent, true, true, false},
        {"zix", "masternodedebug", &masternodedebug, true, true, false},
        {"zix", "startmasternode", &startmasternode, true, true, false},
        {"zix", "createmasternodekey", &createmasternodekey, true, true, false},
        {"zix", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"zix", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"zix", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"zix", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"zix", "getmasternodescores", &getmasternodescores, true, true, false},
        {"zix", "mnbudget", &mnbudget, true, true, false},
        {"zix", "preparebudget", &preparebudget, true, true, false},
        {"zix", "submitbudget", &submitbudget, true, true, false},
        {"zix", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"zix", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"zix", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"zix", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"zix", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"zix", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"zix", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"zix", "checkbudgets", &checkbudgets, true, true, false},
        {"zix", "mnsync", &mnsync, true, true, false},
        {"zix", "spork", &spork, true, true, false},
        {"zix", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"zix", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use zixd, or the -server option to zix-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> zix-cli " + methodname + " " + args + "\n";
}
