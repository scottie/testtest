                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Zix Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and zix: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zZIX"));
...
/** Creates context menu, its actions, and zixs up all the relevant signals for mouse events. */
