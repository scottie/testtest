                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Zix from zZix"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zZix"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zZix));
